...
**
** Created: Sun May 29 23:50:22 2011
...
static const char qt_meta_stringdata_myPushButton[] = {
    "myPushButton\0\0i\0myClicked(int)\0"
    "myUnable()\0myLink()\0"
};
...
int myPushButton::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: myClicked((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: myUnable(); break;
        case 2: myLink(); break;
        default: ;
        }
        _id -= 3;
...
// SIGNAL 0
void myPushButton::myClicked(int _t1)
{
